...
def detail_url(recipe_id):
    """Create adm return a recipe detail url"""
...
def create_recipe(user, **params):
    ...
    defaults = {
        ...
        'time_minutes': 22,
        'price': Decimal('5.25'),
        'description': 'Sampole description',
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            ...
            description='Sample recipe prediction'
        )

        payload = {
            'title': 'New Recipe title',
            'link': 'https://example.com/new-recipe.pdf',
            'description': 'Sample new recipe prediction',
            'time_minutes': 10,
            'price': Decimal('2.50')
        }
    ...
    def test_recipe_other_user_recipe_error(self):
        ...
        new_user = create_user(email='user2@exampl.com',
                               password='testpass123')
    ...
    def test_create_recipe_with_ingredient(self):
        """TEst creating a new recipe with executing ingredient"""
